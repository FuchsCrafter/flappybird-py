...
"IP" is a short form for intellectual property
...
The artwork located in the assets folder of this software belongs to Samuel Custodio, which they provided under the MIT license. The license can be found here: [License](https://github.com/samuelcust/flappy-bird-assets/blob/master/LICENSE). The original IP can be found here: [samuelcust/flappy-bird-assets](https://github.com/samuelcust/flappy-bird-assets/tree/master)
